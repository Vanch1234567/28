// 1. Create a score variable and initialize it to zero.
// 2. Create text for the score and display it.
// 3. Also, display the number of arrows.(See Hint 1)
// 4. Write a condition to check if arrows collide with the boards then increase the
// score by 5. (See Hint 2)
// 5. Create a gameOver function using swal(), add title, text and reload functionality
// in it. (See Hint 3)
// 6. Call the gameOver function in the draw function if the number of arrows is equal
// to zero.
